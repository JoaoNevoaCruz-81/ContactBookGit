...
public class Main {
    ...
    public static final String PHONE_SHARED = "There are contacts that share phone numbers.";
    public static final String PHONE_NOT_SHARED = "All contacts have different phone numbers.";
